    ...
    <div id="myModal" class="modal">
		...
		<!-- ------------------------------Profile Popup ----------------------------- -->
            ...
            <fieldset>
    			...
    			<label for="phone">UserId:</label>
                <input type="text" id="userid" name="userid" value="<%=customer.getUsername() %>" readonly>
    
    
                <label for="name">Name:</label>
                <input type="text" id="name" name="name" value="<%=customer.getFullName()%>" readonly="readonly">
    				
    			
    	
                <label for="email">Email: You Can Change</label>
                <input type="email" id="email" name="email" value="<%=customer.getEmail() %>">
    
              
                <label for="address">Password: You Can Change</label>
                <input type="text" id="pass" name="pass" value="<%=customer.getPassword() %>">
