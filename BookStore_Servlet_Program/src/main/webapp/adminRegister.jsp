	...
	<div class="container col-md-5" >
			<div class="card">
					<div class="card-body">
						...
						<input type="text"  class="form-contro" name="uname" required="required" >
						</fieldset>
						
						<fieldset class="form-group">
						<label>Admin Name :</label>
						<input type="text"  class="form-contro" name="name" required="required">
						</fieldset>
						
						<fieldset class="form-group">
						<label>Admin Email :</label>
						<input type="text"  class="form-contro" name="email" required="required">
						</fieldset>
						
						<fieldset class="form-group">
						<label>Admin Password :</label>
						<input type="text"  class="form-contro" name="pass" required="required">
						</fieldset>
